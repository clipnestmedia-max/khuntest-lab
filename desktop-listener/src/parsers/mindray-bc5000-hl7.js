...
function parseHL7(rawMessage, analyzer = {}) {
  ...
  for (const segment of segments) {
    ...
    const type = fields[0];
    if (type === "MSH") {
      parsed.analyzerName = fields[2] || fields[3] || parsed.analyzerName || "Mindray BC-5000";
    ...
    if (type === "OBX") {
      ...
      parsed.results.push({
        ...
        khunTestName: CBC_CODE_MAP[code] || nameFromMessage || code,
        value: fields[5] || "",
        unit: fields[6] || "",
...
module.exports = { CBC_CODE_MAP, parseHL7, buildAck, stripMllp };
